...
import kotlinx.android.synthetic.main.fragment_women_store.*


class WomenStoreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_women_store, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        items.clear()
        rvWomen.setMultiRv(requireContext(),multiAdapter)
        FirebaseDatabase.getInstance().reference.child("Women")
