...
import kotlinx.android.synthetic.main.fragment_children_store.*


class ChildrenStoreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_children_store, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        items.clear()
        rvChild.setMultiRv(requireContext(),multiAdapter)
